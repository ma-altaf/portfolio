...
var coverTL = animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_1__["default"].timeline();
var coverRevealTimeMS = 1300;
surname.querySelectorAll(".char").forEach(function (el, index) {
  var positionArrX = ["-100%", "0%", "100%", "-100%", "0%", "100%"];
  var positionArrY = ["-100%", "-100%", "-100%", "100%", "100%", "100%"];
  animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_1__["default"].set(el, {
...
animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_1__["default"].set(cover, {
...
coverTL.add({
  ...
  translateY: function translateY() {
    return animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_1__["default"].random(-150, 50) + "%";
  },
  duration: coverRevealTimeMS,
  easing: "easeInOutCubic"
}, "-=".concat(coverRevealTimeMS)).add({
  targets: namebox,
  translateY: "-150%",
  duration: coverRevealTimeMS,
  easing: "easeInOutCubic"
  ...
  targets: cover,
  clipPath: ["polygon(0 0, 100% 0%, 100% 125%, 0 100%)", "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)"],
  duration: coverRevealTimeMS,
  easing: "easeInOutCubic",
...
var scrollbar = smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].init(document.querySelector("main"), {
  damping: 0.07
});

var breakWord = function breakWord(element) {
  element.innerHTML = element.innerText.replace(/\S/g, "<div class='char'><p>$&</p></div>");
};
...
/* harmony import */ var _scripts_coverAnimation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/coverAnimation */ "./src/scripts/coverAnimation.js");
